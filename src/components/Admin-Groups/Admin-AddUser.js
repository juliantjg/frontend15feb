...
function MyVerticallyCenteredModal(props) {
  ...
  useEffect(async () => {
    await axios
      .get(`http://ec2-52-64-254-219.ap-southeast-2.compute.amazonaws.com:8000/api/userEmails/${groupId}`)
      .then((response) => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoad(true);
    await axios
      .post(`http://ec2-52-64-254-219.ap-southeast-2.compute.amazonaws.com:8000/api/groups/addUser` , userForm)
      .then((response) => {
