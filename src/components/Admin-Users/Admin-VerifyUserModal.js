...
function MyVerticallyCenteredModal(props) {
  ...
  useEffect(async () => {
    await axios
      .get(`http://ec2-52-64-254-219.ap-southeast-2.compute.amazonaws.com:8000/api/user/${userId}`)
      .then((response) => {
  ...
  const handleSubmit = async (e) => {
    ...
    await axios
      .put(`http://ec2-52-64-254-219.ap-southeast-2.compute.amazonaws.com:8000/api/user/${userId}`, userForm)
      .then((response) => {
