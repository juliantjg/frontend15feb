...
function MyVerticallyCenteredModal(props) {
  ...
  useEffect(async () => {
    await axios
      .get(`http://ec2-52-64-254-219.ap-southeast-2.compute.amazonaws.com:8000/api/asset/${props.id}`)
      .then((response) => {
  ...
  useEffect(async () => {
    await axios
      .get(`http://ec2-52-64-254-219.ap-southeast-2.compute.amazonaws.com:8000/api/user/${localStorage.getItem("id")}`)
      .then((response) => {
  ...
  const handleSubmit = async (e) => {
    ...
    await axios
      .post(`http://ec2-52-64-254-219.ap-southeast-2.compute.amazonaws.com:8000/api/investment`, userForm)
      .then((response) => {
